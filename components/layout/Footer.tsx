          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 شارع الموبايل, مدينة التكنولوجيا, TC 12345</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full h-64 bg-gray-800 rounded-lg flex items-center justify-center border border-gray-700">
            <p className="text-gray-300 text-center">
              سيتم تضمين خريطة تفاعلية هنا
              <br />
              <span className="text-sm">123 شارع الموبايل, مدينة التكنولوجيا, TC 12345</span>
            </p>
          </div>
        </div>
      </div>
